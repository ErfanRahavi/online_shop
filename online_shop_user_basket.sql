...
CREATE TABLE `user_basket` (
  ...
  KEY `basket_f1_idx` (`product_id`),
  CONSTRAINT `basket_f1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`)
...
INSERT INTO `user_basket` VALUES ('3bb7daae-549b-11ee-8bd7-8c8caab55015',1,3),('3bb7daae-549b-11ee-8bd7-8c8caab55015',2,1),('3bb7daae-549b-11ee-8bd7-8c8caab55015',4,3);
